...
def get_tts():
    ...
    DIM =  (150,150) 
    np.random.seed(10)        
    pistol_paths = [f'../FinalImages/Pistol/{i}' for i in os.listdir('../FinalImages/Pistol')] 
    pistol_labels = [1 for i in range(len(pistol_paths))]
    rifle_paths = [f'../FinalImages/Rifle/{i}' for i in os.listdir('../FinalImages/Rifle')] 
    rifle_labels = [2 for i in range(len(rifle_paths))]    
    neg_paths = [f'../FinalImages/NoWeapon/{i}' for i in os.listdir('../FinalImages/NoWeapon')]
